...
5. 图片尺寸和比例过滤
6. SVG元素专门处理
7. CSS背景图片检测（包括通过CSS隐藏的Logo）
8. 特定属性元素的Logo检测（如data-spm属性）
9. CSS变量和自定义属性中的Logo
10. 增强的属性检测（所有包含'logo'关键字的属性和标签）
...
- 对SVG格式Logo进行了特殊优化处理
- 下载功能需要用户授权访问下载权限
- 能够检测通过CSS背景图片隐藏的Logo（如搜狐网站）
- 增强的检测功能可以识别各种标签和属性中的Logo内容
